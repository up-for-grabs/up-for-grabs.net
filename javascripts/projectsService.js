(function (host, _) {
   ...
   */
  var sortProjectsByRecentlyUpdated = function (projects) {
    ...
    var repos = _.map(projects, function(project) {
        ...
        if ( project['site'].includes("github.com")) {
            ...
            var stems = repo.split("/");
            var repoLocation = stems[stems.length-2] + "/" + stems[stems.length-1];
            return repoLocation;
        }
            ...
            var stems = repo.split("/");
            var repoLocation = stems[0] + "/" + stems[1];            
            return repoLocation;
        }
        else {
            return null;
