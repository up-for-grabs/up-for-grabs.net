...
export const RawProjects : Array<Project> = projects.map(project => {
...
export const InitialProjects : Array<WebsiteProject> = RawProjects.map(project => parseProject(project)).filter((project) => {
